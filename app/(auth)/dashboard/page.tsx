  ...
  return (
    <div className="min-h-dvh bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#232526] text-white">
      ...
      <main className="w-full max-w-full md:max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12 px-2 md:px-6 mt-10 md:mt-20">
        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight flex items-center gap-3 text-[#00c6ff] drop-shadow mb-8 col-span-1 md:col-span-2 lg:col-span-3">
